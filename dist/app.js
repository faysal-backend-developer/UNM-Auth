...
const globalErrorHandler_1 = __importDefault(require("./app/globalErrorHandler/globalErrorHandler"));
...
app.get('/api/v1/test', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {

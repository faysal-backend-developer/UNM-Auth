...
const createAcademicFaculty = (payload) =>
...
const getSingleAcademicFaculty = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getAllAcademicFaculty = (paginationOption, searchOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateAcademicFaculty = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const isFind = yield AcademicFaculty_model_1.academicFaculty.findOne({
      _id: id,
    });
    if (!isFind) {
      throw new ApiError_1.default(
        http_status_codes_1.StatusCodes.NO_CONTENT,
        'Can not find Academic faculty',
      );
    }
    const result =

...
router.post('/create', (0, validationRequest_1.default)(AcademicSemester_validation_1.AcademicSemesterValidation.academicSemesterZodSchema), AcademicSemester_controller_1.AcademicSemesterController.create);
...
router.patch('/:id', (0, validationRequest_1.default)(AcademicSemester_validation_1.AcademicSemesterValidation.updateAcademicSemesterZodSchema), AcademicSemester_controller_1.AcademicSemesterController.updateAcademicSemester);

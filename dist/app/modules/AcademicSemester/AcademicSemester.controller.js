...
const create = (0, catchAsync_1.default)((req, res, next) =>
...
// ! : Get All Semester
const getAllSemester = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filterableFields = (0, pick_1.default)(req.query, [
      'searchTerm',
      'year',
      'title',
    ]);
...
const updateAcademicSemester = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const { semester } = req.body;
    const result =
      yield AcademicSemester_service_1.AcademicSemesterService.updateAcademicSemester(
        id,
        semester,
      );
    (0, requestHandler_1.default)(res, {
...
const deleteAcademicSemester = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield AcademicSemester_service_1.AcademicSemesterService.deleteAcademicSemester(
        id,
      );
    (0, requestHandler_1.default)(res, {
      statusCode: http_status_codes_1.StatusCodes.OK,

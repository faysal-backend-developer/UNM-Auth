...
const createSemester = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (AcademicSemester_constant_1.academicSemesterTitleCodeMapper[payload.title] !== payload.code) {
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Invalid Semester Code');
    }
    const result = yield AcademicSemester_model_1.academicSemester.create(payload);
    if (!result) {
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Academic Semester creation failed');
    }
    return result;
});
const getAllSemester = (paginationOption, filterableField) => __awaiter(void 0, void 0, void 0, function* () {
    const { page = 1, limit = 10, sortBy, sortOrder } = paginationOption;
    const skip = (Number(page) - 1) * Number(limit);
    const { searchTerm } = filterableField, filterField = __rest(filterableField, ["searchTerm"]);
    ...
    if (!result) {
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.NO_CONTENT, "Couldn't  Find Academic Semester");
    }
    return {
        data: result,
        meta: {
...
const updateAcademicSemester = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const firstFind = yield AcademicSemester_model_1.academicSemester.findById(id);
    if (!firstFind) {
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.NO_CONTENT, "Couldn't Find Academic Semester");
    }
    if ((payload === null || payload === void 0 ? void 0 : payload.title) && (payload === null || payload === void 0 ? void 0 : payload.code)) {
        if (AcademicSemester_constant_1.academicSemesterTitleCodeMapper[payload.title] !== payload.code) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Invalid Academic Semester Title and Code');
        }
    }
    const findAll = yield AcademicSemester_model_1.academicSemester.find({}, { title: 1, year: 1, _id: 0 });
    if (findAll &&
        typeof findAll === 'object' &&
        Object.keys(findAll).length > 0) {
        if (Array.isArray(findAll) && findAll.length > 0) {
            findAll.forEach((entry) => {
                if (entry.title === (payload === null || payload === void 0 ? void 0 : payload.title) && entry.year == (payload === null || payload === void 0 ? void 0 : payload.year)) {
                    throw new ApiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Academic Semester Already Exist');
                }
            });
        }
    }
    ...
    if (!result) {
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.NO_CONTENT, "Couldn't Update Academic Semester");
    }
    return result;
});
const deleteAcademicSemester = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.NO_CONTENT, "Couldn't Delete Academic Semester");
    }
    return result;
});

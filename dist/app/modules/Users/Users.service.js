...
const createStudent = (studentData, userData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const id = yield (0, Users_utils_1.generatedStudentId)(
        academicSemesterId,
      );
      userData.id = id;
      studentData.id = id;
      const createStudent = yield Student_model_1.student.create(
        [studentData],
        { session },
      );
      ...
      const createUser = yield Users_model_1.User.create([userData], {
        session,
      });
    ...
    if (allUserData) {
      allUserData = yield Users_model_1.User.findOne({
        id: allUserData.id,
      }).populate({
        path: 'student',
        populate: [

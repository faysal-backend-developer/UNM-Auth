...
const createDepartment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = (yield Department_model_1.department.create(payload)).populate({
        path: 'academicFaculty',
    });
    if (!result) {
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.NO_CONTENT, 'Error creating department');
    }
    return result;
});
const readSingleDepartment = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield Department_model_1.department.findById({ _id: id }).populate({
        path: 'academicFaculty',
    });
    if (!result) {
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Department not found');
    }
    return result;
});
// ! All Data Read :
const readDepartment = (paginationOption, searchOption) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.NO_CONTENT, 'No departments found');
    }
    return {
        data: result,
        meta: {
...
const updateDepartment = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, "Couldn't updated department");
    }
    return result;
});

...
router.post('/create', (0, validationRequest_1.default)(Department_validation_1.DepartmentZodSchema.createDepartment), Department_controller_1.DepartmentController.createDepartment);
router.get('/:id', Department_controller_1.DepartmentController.readSingleDepartment);
router.patch('/:id', (0, validationRequest_1.default)(Department_validation_1.DepartmentZodSchema.updateDepartment), Department_controller_1.DepartmentController.updateDepartment);
